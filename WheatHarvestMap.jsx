...
function DrillMap({ level, village, focusedDistrict, selected, onPickState, onPickVillage, onPickField, onHoverField, onZoomToField, onFocusDistrict }) {
  ...
  useEffect(() => {
    ...
    VILLAGES.forEach((v) => {
      ...
      inner.setAttribute("aria-label", `${v.name} - ${villageCount(v.key)} fields`);
      inner.title = `${v.name} - ${villageCount(v.key)} fields`;
      ...
      <div className="mx-auto" style={{ maxWidth: 1180 }}>
        <div className="mb-10 md:mb-14">
          ...
          <p className="mt-5" style={{ color: C.mute, maxWidth: "62ch", lineHeight: 1.65, fontSize: "1.05rem" }}>
            The programme ran across {VILLAGES.length} villages in Ludhiana and Faridkot, Punjab. All {TOTAL_FIELDS}{" "}
